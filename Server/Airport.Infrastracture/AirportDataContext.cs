    ...
    public class AirportDataContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Leg>().HasData(
                ...
                new Leg { Id = 4, CurrentLeg = (Core.Enums.LegNumber.Fou), NextPosibbleLegs = Core.Enums.LegNumber.Fiv | Core.Enums.LegNumber.Air, LegType = Core.Enums.LegType.Process | Core.Enums.LegType.BeforeFly, PauseTime = 2 },
